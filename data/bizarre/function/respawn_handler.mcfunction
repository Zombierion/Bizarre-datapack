...
execute if score @s[tag=bizarre.respawn] bizarre.respawn matches ..0 run scoreboard players set @s bizarre.health 10
execute if score @s[tag=bizarre.respawn,tag=voidwalker.shifted] bizarre.respawn matches ..0 run function voidwalker:void_shift_reset
