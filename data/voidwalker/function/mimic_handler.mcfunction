...
execute at @p[predicate=bizarre:uid_search,tag=!voidwalker.shifted,tag=!bizarre.respawn] run execute in voidwalker:the_shift run tp @s ~ ~ ~ ~ ~
execute at @p[predicate=bizarre:uid_search,tag=voidwalker.shifted,predicate=!bizarre:fall_reset] run tp @s 0 400 0
execute at @p[predicate=bizarre:uid_search,tag=bizarre.respawn] run tp @s 0 400 0
