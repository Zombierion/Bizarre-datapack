...
##  VOID AMBIANCE
execute as @a[tag=!bizarre.respawn,tag=voidwalker.shifted,tag=!voidwalker.ultimate] at @s in minecraft:overworld run particle minecraft:dust{color:[1, 0, 1], scale:1} ~ ~1.5 ~ 0.25 0.5 0.25 1 10 force
...
execute as @a[tag=class.VoidWalker,tag=voidwalker.shifted] at @s run particle minecraft:dust{color:[0,0,0],scale:1} ~ ~ ~ 20 20 20 1 100 force
